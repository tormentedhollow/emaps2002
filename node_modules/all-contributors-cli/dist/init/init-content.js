...
var headerContent = 'Thanks goes to these wonderful people ([emoji key](https://github.com/all-contributors/all-contributors#emoji-key)):';
var listContent = ['<!-- ALL-CONTRIBUTORS-LIST:START - Do not remove or modify this section -->', '<!-- prettier-ignore -->', '<!-- ALL-CONTRIBUTORS-LIST:END -->'].join('\n');
